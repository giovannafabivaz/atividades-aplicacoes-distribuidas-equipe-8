...
public class Consumer extends Thread {
    ...
    public void run() {
        try {
            ...
            try {
                ...
                System.out.println("Erro ao fechar o pipe do Consumer: " + e.getMessage());
            }
        }
    }
    ...
    private void imprimirRelatorio() {
        ...
        double percentualFora = (foraDaFaixa * 100.0) / totalProcessado;
        ...
        System.out.printf("Fora da faixa: %d (%.2f%%)%n", foraDaFaixa, percentualFora);
